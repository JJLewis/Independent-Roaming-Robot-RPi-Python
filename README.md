Independent Roaming Robot
=============
This project will use a Rasberry Pi Model B+ and Python to make a robot that is smart enough to charge itself when low on power by returning to a base station.
